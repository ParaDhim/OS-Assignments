		...
		if (strcmp("exit",comd) == 0){
			...
			*/
			...
			else if(strcmp(comdWord[0],"echo") == 0)
			{
				...
				else if(strcmp(comdWord[1],"--help") == 0 && comdWord[2] == 0)
				{
					FILE *ptrFile1;
			...
			else if(strcmp(comdWord[0],"cat") == 0)
			{
				...
				pthread_t tid;
				pthread_create(&tid1,NULL,catRunner,NULL);
			...
			else if(strcmp(comdWord[0],"mkdir") == 0)
			{
				...
				char *testingArgs[] = {"sh","-c","gcc -o /home/paras/ques/assmt2/mkdir.o /home/paras/ques/assmt2/mkdir.c; /home/paras/ques/assmt2/mkdir.o"};
